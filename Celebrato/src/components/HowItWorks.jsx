            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-4 pb-6">
                    ...
                    <div className="bg-white p-8 flex shadow-md rounded-lg relative">
                        ...
                        <div className="flex flex-col w-[60%] h-[25vh] p-0  items-start  text-start ">
                    ...
                    <div className="bg-white p-8 flex shadow-md rounded-lg relative">
                        ...
                        <div className="flex flex-col w-[65%] h-[20vh] p-0  items-start  text-start ">
                            ...
                            <p className="text-gray-600 font-Rubik pb-10">Choose themes, set budgets, and manage guest lists with our easy-to-use tools.</p>
                        </div>
                    </div>
